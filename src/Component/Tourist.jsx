...
function Tourist() {
  ...
  <div className="card" style={{width: '40rem'}}>
      ...
      <div className="card-body">
        ...
        <p className="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo tempora eos sit at sint labore, sapiente dicta nostrum qui ab! Alias sunt ex, quidem et iste illum sequi in quae.</p>
